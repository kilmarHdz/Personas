package com.gamma.personas.Entidades;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String CREAR_TABLA_USUARIO = "CREATE TABLE "+ TABLA_USUARIOS+"("+CAMPO_ID+" TEXT,"+ CAMPO_NOMBRE +" TEXT)";
    ...
    public Persona findUser(String dui){
        ...
        try {
            Cursor cursor = db.query(TABLA_USUARIOS, campos,CAMPO_ID+"=?",parametros,null,
                    null,null);
            cursor.moveToFirst();
